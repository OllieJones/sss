 ...
 * Admin API class.
 */
class Super_Sonic_Search_Admin_API {
  ...
  public function display_field( $data = [], $post = null, $echo = true ) {
    ...
    switch ( $field['type'] ) {
      ...
      case 'image':
        ...
        $html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'super-sonic-search' ) . '" data-uploader_button_text="' . __( 'Use image', 'super-sonic-search' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'super-sonic-search' ) . '" />' . "\n";
        $html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'super-sonic-search' ) . '" />' . "\n";
