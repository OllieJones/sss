...
class Super_Sonic_Search {
	 ...
	 *
	 * @return bool|string|Super_Sonic_Search_Post_Type
	 */
	public function register_post_type( $post_type = '', $plural = '', $single = '', $description = '', $options = array() ) {
		...
		$post_type = new Super_Sonic_Search_Post_Type( $post_type, $plural, $single, $description, $options );
	 ...
	 *
	 * @return bool|string|Super_Sonic_Search_Taxonomy
	 */
	public function register_taxonomy( $taxonomy = '', $plural = '', $single = '', $post_types = array(), $taxonomy_args = array() ) {
		...
		$taxonomy = new Super_Sonic_Search_Taxonomy( $taxonomy, $plural, $single, $post_types, $taxonomy_args );
	...
	public function load_localisation() {
		load_plugin_textdomain( 'super-sonic-search', false, dirname( plugin_basename( $this->file ) ) . '/lang/' );
